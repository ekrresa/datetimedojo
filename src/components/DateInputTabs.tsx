...
export default function DateInputTabs(props: Props) {
  ...
  return (
    <Tabs className="flex orientation-horizontal:flex-col">
      ...
      <TabPanel
        id="select-date"
        className="mt-2 flex items-start gap-1 outline-none"
      >
        <DateField
          granularity="second"
        ...
        >
              ...
              <DateSegment
                className={({ isPlaceholder, isFocused }) =>
                  `relative tabular-nums type-literal:px-1 focus:outline-none ${
                    ...
                    isFocused
                      ? "rounded-sm bg-opium-800 text-white caret-transparent"
                      : ""
                  }`
                }
                segment={segment}
          ...
          <Text
            ...
            slot="description"
          >
            Input a date and time by filling all segments. Date is in 24h
            format.
          </Text>
        </DateField>
      </TabPanel>
